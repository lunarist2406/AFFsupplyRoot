import { FaBox, FaTachometerAlt,FaWarehouse,  FaStore, FaSpellCheck, FaMoneyBillWave } from "react-icons/fa"
...
> = {
  6: [
    { label: "Đơn hàng", href: "/account/orders", icon: <FaBox className="text-yellow-secondary w-4 h-4" /> },
  ],
  4 : [
  ...
  1: [
    ...
    // { label: "Quản lý phân quyền", href: "/admin/permissions", icon: <FaShieldAlt className="text-yellow-secondary w-4 h-4" /> },
      { label: "Quản lý người bán", href: "/admin/registerseller", icon: <FaSpellCheck className="text-yellow-secondary w-4 h-4" /> },
        { label: "Quản lý doanh thu", href: "/admin/revenue", icon: <FaMoneyBillWave className="text-yellow-secondary w-4 h-4" /> },
  ],
  3: [
