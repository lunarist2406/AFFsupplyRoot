...
export default function ProfilePage() {
  ...
  if (error || !profile) return <div className="container mx-auto px-4 py-8 text-red-500">{error || "Không có dữ liệu"}</div>
      ...
      {showSuccessMessage && (
        <div className="md:col-span-4 mb-4 p-4 bg-green-50 border border-green-200 rounded-md">
          <div className="flex items-center">
            ...
            <span className="text-green-700 font-medium">Xác thực OTP thành công! Email đã được cập nhật.</span>
          </div>
        </div>
      )}
          ...
          <div className="md:col-span-3">
            ...
            {activeTab === "change-password" && (
              <div className="bg-white rounded-md shadow-sm p-6">
                ...
                <button
                  onClick={() => window.location.href = "/account/profile/verify-password"}
